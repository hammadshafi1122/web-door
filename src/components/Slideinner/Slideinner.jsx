  ...
  return (
    <div className='space-y-10 lg:w-full lg:space-y-0'>
        <div className='space-y-2 '>
          <div className='px-[-1rem]'><span className='font-bold text-base sm:mx-[5rem] sm:text-2xl md:mx-[9rem]'>What our customers are saying </span></div>
          <div><hr /></div>
        </div>

        <div className='space-y-5 sm:space-y-14 lg:space-y-6  lg:flex'>
            <div className='flex space-x-4 sm:mx-[5rem] lg:space-x-7  lg:w-[50rem]  lg:my-[1rem]'>
                <div ><img className='rounded-full lg:my-[1rem] lg:w-[10rem] lg:h-[10rem]' src={Image1} alt="" /></div>
                <div className='my-[1.5rem] space-y-2'>
